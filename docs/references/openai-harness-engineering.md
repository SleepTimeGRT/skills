...
![Codex drives the app with Chrome DevTools MCP to validate its work](https://images.ctfassets.net/kftzwdyauwt9/1Gu58eNlqDEuITmbqJDmq9/1e2e62f7e15fb16d2da0da5407240564/fig_1__codex_drives_the_app_.png?fm=webp&q=90&w=3840)
...
[Diagram: Giving Codex a full observability stack in local dev](https://openai.com/index/harness-engineering/)
...
![The limits of agent knowledge: What Codex can't see doesn't exist](./OAI_Harness_engineering_The_limits_of_agent_knowledge_desktop-light.webp)
...
![Layered domain architecture with explicit cross-cutting boundaries](./OAI_Harness_engineering_Layered_domain_architecture_with_explicit_cross-cutting_boundries_desktop-light.webp)
